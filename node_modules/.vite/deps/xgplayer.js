...
var require_dist = __commonJS({
  "node_modules/xgplayer/dist/index.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      return function(modules) {
        ...
        function(module2) {
          module2.exports = JSON.parse('{"version":"2.31.7"}');
        },
        function(module2, exports2, __webpack_require__) {
          "use strict";
          Object.defineProperty(exports2, "__esModule", {
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          (function(module3) {
            ...
            !function(e, t) {
              "object" == (false ? void 0 : _typeof(exports2)) && "object" == (false ? void 0 : _typeof(module3)) ? module3.exports = t() : true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = t, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.apply(exports2, __WEBPACK_AMD_DEFINE_ARRAY__) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== void 0 && (module3.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : void 0;
            }(window, function() {
              return function(e) {
                var t = {};
                function n(i) {
                ...
                var i = { createDom: function createDom() {
                  var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "div", t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", o = document.createElement(e2);
                  return o.className = i2, o.innerHTML = t2, Object.keys(n2).forEach(function(t3) {
                    var i3 = t3, r = n2[t3];
                    "video" === e2 || "audio" === e2 ? r && o.setAttribute(i3, r) : o.setAttribute(i3, r);
                  }), o;
                }, hasClass: function hasClass(e2, t2) {
                  return e2.classList ? Array.prototype.some.call(e2.classList, function(e3) {
                    return e3 === t2;
                  }) : !!e2.className.match(new RegExp("(\\s|^)" + t2 + "(\\s|$)"));
                }, addClass: function addClass(e2, t2) {
                  e2.classList ? t2.replace(/(^\s+|\s+$)/g, "").split(/\s+/g).forEach(function(t3) {
                    t3 && e2.classList.add(t3);
                  }) : i.hasClass(e2, t2) || (e2.className += " " + t2);
                }, removeClass: function removeClass(e2, t2) {
                ...
                }, toggleClass: function toggleClass(e2, t2) {
                  ...
                  if ("Object" === i.typeOf(t2) && "Object" === i.typeOf(e2))
                    return Object.keys(t2).forEach(function(n2) {
                      "Object" !== i.typeOf(t2[n2]) || t2[n2] instanceof Node ? "Array" === i.typeOf(t2[n2]) ? e2[n2] = "Array" === i.typeOf(e2[n2]) ? e2[n2].concat(t2[n2]) : t2[n2] : e2[n2] = t2[n2] : e2[n2] ? i.deepCopy(e2[n2], t2[n2]) : e2[n2] = t2[n2];
                    }), e2;
                }, typeOf: function typeOf(e2) {
                ...
                var d = function(e2) {
                  function t2(e3) {
                    ...
                    }), !i2.config.container || 1 !== i2.config.container.nodeType)
                  ...
                  return function(e3, t3) {
                    ...
                    e3 && t3 && (this.bulletBtn.main.data.some(function(n3) {
                      ...
                      return o2.id === e3 && (o2.id = t3, o2.pauseMove(i2), "paused" !== n2.bulletBtn.main.status && o2.startMove(i2), true);
                    }));
                    ...
                    e3 && t3 && (t3 = t3 || 5e3, this.bulletBtn.main.data.some(function(n3) {
                      ...
                      return o2.id === e3 && (o2.duration = t3, o2.pauseMove(i2), "paused" !== n2.bulletBtn.main.status && o2.startMove(i2), true);
                    }));
                    ...
                    this.like = t3, e3 && t3 && (this.bulletBtn.main.data.some(function(n3) {
                      ...
                      return i2.id === e3 && (i2.pauseMove(n2), i2.setLikeDom(t3.el, t3.style), "paused" !== i2.danmu.bulletBtn.main.status && i2.startMove(n2), true);
                    }));
                    ...
                    e3 && this.bulletBtn.main.queue.some(function(n2) {
                      return n2.id === e3 && ("paused" !== n2.danmu.bulletBtn.main.status ? n2.startMove(t3, true) : n2.status = "paused", true);
                    });
                    ...
                    var e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "scroll", t3 = arguments[1], n2 = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
                    ...
                    t3 && (t3 = t3 || 5e3, n2 && (this.bulletBtn.main.forceDuration = t3), this.bulletBtn.main.data.forEach(function(n3) {
                      ...
                      e3 === n3.mode && (n3.duration = t3, n3.pauseMove(i2), "paused" !== n3.danmu.bulletBtn.main.status && n3.startMove(i2));
                    }));
                ...
                o = function o2(e2, t2) {
                  ...
                  var n2;
                  return f(t2), v.call(this, "__ee__") ? n2 = this.__ee__ : (n2 = b.value = g(null), p(this, "__ee__", b), b.value = null), n2[e2] ? "object" == _typeof(n2[e2]) ? n2[e2].push(t2) : n2[e2] = [n2[e2], t2] : n2[e2] = t2, this;
                  ...
                  return null == e2 ? g(u) : m(Object(e2), l);
                }, t.methods = s;
              }, function(e, t, n) {
                "use strict";
                ...
                var u = function(e2) {
                  ...
                  return function(e3, t3) {
                    ...
                    t3.retryTimer || function e4() {
                      "closed" === t3.status && "stop" === t3.retryStatus || ("playing" === t3.status && (t3.readData(), t3.dataHandle()), "stop" === t3.retryStatus && "paused" !== t3.status || (t3.dataHandleTimer = setTimeout(function() {
                        e4();
                      }, t3.interval - 1e3)));
                    }();
                  } }, { key: "start", value: function value() {
                    ...
                    var e3 = this;
                    "paused" !== this.status && "closed" !== this.status && e3.queue.length && e3.queue.forEach(function(t3) {
                      "waiting" === t3.status && t3.startMove(e3.channel.containerPos);
                    });
                    ...
                    if (t3.isReady) {
                      ...
                      }), t3.live && (e3.data = [])) : 0 === (l2 = e3.data.splice(0, 1)).length && (l2 = e3.playedData.splice(0, 1)), l2.length > 0 && l2.forEach(function(n3) {
                ...
                var s = function(e2) {
                  ...
                  return function(e3, t3) {
                    ...
                    n2.resizing || (n2.resizing = true, this.resizeTimer = setTimeout(function() {
                      ...
                      n2.width = i2.width, n2.height = i2.height, n2.danmu.config.area && n2.danmu.config.area.start >= 0 && n2.danmu.config.area.end >= n2.danmu.config.area.start && ("b2t" === n2.direction ? n2.width = n2.width * (n2.danmu.config.area.end - n2.danmu.config.area.start) : n2.height = n2.height * (n2.danmu.config.area.end - n2.danmu.config.area.start)), n2.container = t3;
                      var o2 = n2.danmu.config.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12), r2 = void 0;
                      r2 = "b2t" === n2.direction ? Math.floor(n2.width / o2) : Math.floor(n2.height / o2);
                      ...
                      if (n2.channels && n2.channels.length <= a2.length) {
                        for (var l = function l2(t4) {
                          a2[t4] = { id: t4, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} }, ["scroll", "top"].forEach(function(i3) {
                            n2.channels[t4].queue[i3].forEach(function(o3) {
                              o3.el && (a2[t4].queue[i3].push(o3), o3.resized || (o3.pauseMove(n2.containerPos, e3), "paused" !== o3.danmu.bulletBtn.main.status && o3.startMove(n2.containerPos), o3.resized = true));
                            });
                            ...
                            if (i3.el) {
                              ...
                              i3.resized || (i3.pauseMove(n2.containerPos, e3), "paused" !== i3.danmu.bulletBtn.main.status && i3.startMove(n2.containerPos), i3.resized = true);
                            }
                          });
                        ...
                        n2.channels = a2, "b2t" === n2.direction ? n2.channelWidth = o2 : n2.channelHeight = o2;
                        ...
                        for (var h = function h2(t4) {
                          a2[t4] = { id: t4, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} }, ["scroll", "top", "bottom"].forEach(function(i3) {
                            if ("top" === i3 && t4 > Math.floor(a2.length / 2))
                              ;
                            else if ("bottom" === i3 && t4 <= Math.floor(a2.length / 2))
                              ;
                            else {
                              var r3 = "bottom" === i3 ? t4 - a2.length + n2.channels.length : t4;
                              n2.channels[r3].queue[i3].forEach(function(s3, l2) {
                                if (s3.el) {
                                  if (a2[t4].queue[i3].push(s3), "bottom" === i3 && s3.channel_id[0] + s3.channel_id[1] - 1 === r3) {
                                  ...
                                  s3.pauseMove(n2.containerPos, e3), "paused" !== s3.danmu.bulletBtn.main.status && s3.startMove(n2.containerPos), s3.resized || (s3.resized = true);
                                }
                      ...
                      for (var h = 0, d = i2.length - a2; h <= d; h++) {
                        ...
                        for (var g = h; g < h + a2; g++) {
                          ...
                          if (p) {
                            ...
                            if ("b2t" === t3.direction ? (y = (m.top - t3.containerPos.top + m.height) / (b = (t3.containerPos.height + m.height) / p.duration), w = t3.containerPos.height, _ = (t3.containerPos.height + e3.height) / e3.duration) : (y = (m.left - t3.containerPos.left + m.width) / (b = (t3.containerPos.width + m.width) / p.duration), w = t3.containerPos.width, _ = (t3.containerPos.width + e3.width) / e3.duration), v = w / _, n2.config.bOffset || (n2.config.bOffset = 0), b < _ && y + n2.config.bOffset > v) {
                              s2 = false, l.operating.scroll = false;
                              break;
                            }
                          }
                    ...
                    if (-1 !== u) {
                      ...
                      return e3.channel_id = [u, a2], "b2t" === t3.direction ? (e3.top = u * r2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerWidth * t3.danmu.config.area.start)) : (e3.top = u * o2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerHeight * t3.danmu.config.area.start)), { result: e3, message: "success" };
                    }
                    ...
                    t3.width = n2.width, t3.height = n2.height, t3.danmu.config.area && t3.danmu.config.area.start >= 0 && t3.danmu.config.area.end >= t3.danmu.config.area.start && ("b2t" === t3.direction ? t3.width = t3.width * (t3.danmu.config.area.end - t3.danmu.config.area.start) : t3.height = t3.height * (t3.danmu.config.area.end - t3.danmu.config.area.start)), t3.container = e3;
                    var i2 = t3.danmu.config.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12), o2 = void 0;
                    o2 = "b2t" === t3.direction ? Math.floor(t3.width / i2) : Math.floor(t3.height / i2);
                    ...
                    if (t3.channels && t3.channels.length <= r2.length) {
                      ...
                      t3.channels = r2, "b2t" === t3.direction ? t3.channelWidth = i2 : t3.channelHeight = i2;
                      ...
                      for (var f = function f2(e4) {
                        r2[e4] = { id: e4, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} }, ["scroll", "top", "bottom"].forEach(function(n3) {
                          if ("top" === n3 && e4 > Math.floor(r2.length / 2))
                            ;
                          else if ("bottom" === n3 && e4 <= Math.floor(r2.length / 2))
                            ;
                          else {
                            var o3 = "bottom" === n3 ? e4 - r2.length + t3.channels.length : e4;
                            t3.channels[o3].queue[n3].forEach(function(a3, s3) {
                              if (a3.el) {
                                if (r2[e4].queue[n3].push(a3), "bottom" === n3 && a3.channel_id[0] + a3.channel_id[1] - 1 === o3) {
                    ...
                    function i2() {
                      ...
                      n2.width = e4.width, n2.height = e4.height, n2.danmu.config.area && n2.danmu.config.area.start >= 0 && n2.danmu.config.area.end >= n2.danmu.config.area.start && ("b2t" === n2.direction ? n2.width = n2.width * (n2.danmu.config.area.end - n2.danmu.config.area.start) : n2.height = n2.height * (n2.danmu.config.area.end - n2.danmu.config.area.start)), n2.container = t3;
                      var i3 = n2.danmu.config.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12), o2 = void 0;
                      o2 = "b2t" === n2.direction ? Math.floor(n2.width / i3) : Math.floor(n2.height / i3);
                      for (var r2 = [], a2 = 0; a2 < o2; a2++) {
                        r2[a2] = { id: a2, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} };
                      }
                      n2.channels = r2, "b2t" === n2.direction ? n2.channelWidth = i3 : n2.channelHeight = i3;
                    }
                    ...
                    i2.width = o2.width, i2.height = o2.height, i2.danmu.config.area && i2.danmu.config.area.start >= 0 && i2.danmu.config.area.end >= i2.danmu.config.area.start && ("b2t" === i2.direction ? i2.width = i2.width * (i2.danmu.config.area.end - i2.danmu.config.area.start) : i2.height = i2.height * (i2.danmu.config.area.end - i2.danmu.config.area.start)), i2.container = n2;
                    var r2 = i2.danmu.config.channelSize || (/mobile/gi.test(navigator.userAgent) ? 10 : 12), a2 = void 0;
                    a2 = "b2t" === i2.direction ? Math.floor(i2.width / r2) : Math.floor(i2.height / r2);
                ...
                var s = function(e2) {
                  function t2(e3, n2) {
                    ...
                    var a2 = void 0;
                    if (i2.domObj = e3.domObj, n2.el && 1 === n2.el.nodeType) {
                      a2 = i2.domObj.use();
                    ...
                    "top" === n2.mode || "bottom" === n2.mode ? i2.mode = n2.mode : i2.mode = "scroll", i2.el = a2, n2.like && n2.like.el && i2.setLikeDom(n2.like.el, n2.like.style), i2.status = "waiting";
                  ...
                  return function(e3, t3) {
                    ...
                    var n2 = this;
                    if ("paused" !== this.status && ("forcedPause" !== n2.status && (this.status = "paused"), clearTimeout(n2.removeTimer), this.el))
                      if (r.default.style(this.el, "willChange", "auto"), "scroll" === this.mode) {
                        if (t3) {
                          var i2 = (new Date().getTime() - n2.moveTime) / 1e3, o2 = i2 * this.moveV, a2 = 0;
                          a2 = n2.moveMoreS - o2 >= 0 ? "b2t" === this.direction ? (n2.moveMoreS - o2) / n2.moveContainerHeight * e3.height : (n2.moveMoreS - o2) / n2.moveContainerWidth * e3.width : n2.moveMoreS - o2, "b2t" === this.direction ? r.default.style(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + a2 + "px) translateZ(0px) rotate(90deg)") : r.default.style(this.el, "left", a2 + "px");
                        } else
                          "b2t" === this.direction ? r.default.style(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + (this.el.getBoundingClientRect().top - e3.top) + "px) translateZ(0px) rotate(90deg)") : r.default.style(this.el, "left", this.el.getBoundingClientRect().left - e3.left + "px");
                        "b2t" === this.direction || r.default.style(this.el, "transform", "translateX(0px) translateY(0px) translateZ(0px)"), r.default.style(this.el, "transition", "transform 0s linear 0s");
                      } else
                    ...
                    var n2 = this;
                    if (n2.hasMove || (n2.danmu.emit("bullet_start", n2), n2.hasMove = true), ("forcedPause" !== n2.status || t3) && this.el && "start" !== this.status)
                      if (this.status = "start", r.default.style(this.el, "willChange", "transform"), "scroll" === this.mode) {
                    ...
                    function l() {
                      if (n2.el)
                        if ("scroll" === n2.mode) {
                          ...
                          "b2t" === n2.direction ? t4 && t4.bottom <= e4.top + 100 ? (n2.status = "end", n2.remove()) : (n2.pauseMove(e4), "paused" !== n2.danmu.bulletBtn.main.status && n2.startMove(e4)) : t4 && t4.right <= e4.left + 100 ? (n2.status = "end", n2.remove()) : (n2.pauseMove(e4), "paused" !== n2.danmu.bulletBtn.main.status && n2.startMove(e4));
                        } else
...
// dep:xgplayer
var xgplayer_default = require_dist();
export {
  xgplayer_default as default
};
/*!
* Draggabilly v2.4.1

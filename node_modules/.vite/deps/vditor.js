    ...
    !function(e, t) {
      ...
      return (() => {
        var e = { 760: (e2) => {
          ...
          }, u = n2(466), p = n2(554), m = n2(40), f = n2(749), h = n2(818), v = n2(408), g = n2(54), y = n2(227), b = n2(526), w = n2(827), E = n2(640), k = n2(895), S = n2(393), C = function(e3, t3) {
              ...
              return T(this, function(E2) {
                switch (E2.label) {
                  ...
                  case 7:
                    E2.sent(), E2.label = 8;
                  case 8:
                    return (0, y.Z)(i2.theme.current, i2.theme.path), 1 === i2.anchor && e3.classList.add("vditor-reset--anchor"), (0, a.O)(e3), (0, d.s)(i2.hljs, e3, i2.cdn), (0, u.H)(e3, { cdn: i2.cdn, math: i2.math }), (0, m.i)(e3, i2.cdn, i2.mode), (0, l.P)(e3, i2.cdn), (0, s.v)(e3, i2.cdn), (0, o.p)(e3, i2.cdn, i2.mode), (0, f.P)(e3, i2.cdn, i2.mode), (0, v.B)(e3, i2.cdn), (0, r2.Q)(e3, i2.cdn), (0, p.Y)(e3), i2.speech.enable && C(e3), 0 !== i2.anchor && (k2 = i2.anchor, document.querySelectorAll(".vditor-anchor").forEach(function(e4) {
                      1 === k2 && e4.classList.add("vditor-anchor--left"), e4.onclick = function() {
          ...
          var r2 = n2(51), i = function(e3) {
            e3.querySelectorAll("pre > code").forEach(function(t3, n3) {
              ...
              if (!t3.parentElement.classList.contains("vditor-wysiwyg__pre") && !t3.parentElement.classList.contains("vditor-ir__marker--pre") && !(t3.classList.contains("language-mermaid") || t3.classList.contains("language-flowchart") || t3.classList.contains("language-echarts") || t3.classList.contains("language-mindmap") || t3.classList.contains("language-plantuml") || t3.classList.contains("language-abc") || t3.classList.contains("language-graphviz") || t3.classList.contains("language-math") || t3.style.maxHeight.indexOf("px") > -1 || e3.classList.contains("vditor-preview") && n3 > 5)) {
                ...
                c.className = "vditor-copy", c.innerHTML = '<span aria-label="' + ((null === (i2 = window.VditorI18n) || void 0 === i2 ? void 0 : i2.copy) || "\u590D\u5236") + `"
        ...
        return (() => {
          ...
          var e2, t2 = n(872), i = n(54), o = n(51), a = function(e3) {
            ...
            if (e3.previousElementSibling && e3.previousElementSibling.classList.contains("vditor-toc")) {
              if ("Backspace" === n2.key && 0 === (0, N.im)(e3, t3[t3.currentMode].element, r2).start)
            ...
            if (e3.nextElementSibling && e3.nextElementSibling.classList.contains("vditor-toc")) {
              if ("Delete" === n2.key && (0, N.im)(e3, t3[t3.currentMode].element, r2).start >= e3.textContent.trimRight().length)
            ...
            if (o2 && !n2 && "code-block" !== o2.getAttribute("data-type")) {
              if (ot(o2.innerHTML) && o2.previousElementSibling || at(o2.innerHTML))
                return;
              for (var l2 = (0, N.im)(o2, e3.ir.element, t3).start, s2 = true, d2 = l2 - 1; d2 > o2.textContent.substr(0, l2).lastIndexOf("\n"); d2--)
            ...
            if (w("SpinVditorIRDOM", v2, "argument", e3.options.debugger), v2 = e3.lute.SpinVditorIRDOM(v2), w("SpinVditorIRDOM", v2, "result", e3.options.debugger), f2)
              ...
              var C2 = (0, y.a1)(e3.ir.element.querySelector("wbr"), "data-type", "footnotes-def");
              if (C2) {
                var L2 = C2.textContent, T2 = L2.substring(1, L2.indexOf("]:")), M2 = e3.ir.element.querySelector('sup[data-type="footnotes-ref"][data-footnotes-label="' + T2 + '"]');
                M2 && M2.setAttribute("aria-label", L2.substr(T2.length + 3).trim().substr(0, 24));
              }
            }
            var A2, x2 = e3.ir.element.querySelectorAll("[data-type='link-ref-defs-block']");
            x2.forEach(function(e4, t4) {
              0 === t4 ? m2 = e4 : (m2.insertAdjacentHTML("beforeend", e4.innerHTML), e4.remove());
            }), x2.length > 0 && e3.ir.element.insertAdjacentElement("beforeend", x2[0]);
            ...
            if (o2 && t3 && ("deleteContentBackward" === t3.inputType || " " === t3.data)) {
              ...
              if ("deleteContentBackward" === t3.inputType) {
                ...
                if (u2) {
                  ...
                  return void (p2 && "math-block-close-marker" === p2.getAttribute("data-type") && (p2.remove(), De(e3)));
                }
          ...
          var K, F, Z = function(t3) {
            ...
            clearTimeout(e3[e3.currentMode].hlToolbarTimeoutId), e3[e3.currentMode].hlToolbarTimeoutId = window.setTimeout(function() {
              if ("false" !== e3[e3.currentMode].element.getAttribute("contenteditable") && (0, N.Gb)(e3[e3.currentMode].element)) {
            ...
            r2 || (r2 = n2.startContainer.childNodes[n2.startOffset]), r2 || 0 !== e3.wysiwyg.element.children.length || (r2 = e3.wysiwyg.element), r2 && !r2.classList.contains("vditor-wysiwyg__block") && (n2.insertNode(document.createElement("wbr")), "<wbr>" === r2.innerHTML.trim() && (r2.innerHTML = "<wbr><br>"), "BLOCKQUOTE" === r2.tagName || r2.classList.contains("vditor-reset") ? r2.innerHTML = "<" + t3 + ' data-block="0">' + r2.innerHTML.trim() + "</" + t3 + ">" : r2.outerHTML = "<" + t3 + ' data-block="0">' + r2.innerHTML.trim() + "</" + t3 + ">", (0, N.ib)(e3.wysiwyg.element, n2), D(e3));
          }, te = function(e3) {
            ...
            clearTimeout(e3.wysiwyg.hlToolbarTimeoutId), e3.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function() {
              if ("false" !== e3.wysiwyg.element.getAttribute("contenteditable") && (0, N.Gb)(e3.wysiwyg.element)) {
                c(e3.toolbar.elements, i.g.EDIT_TOOLBARS), p(e3.toolbar.elements, i.g.EDIT_TOOLBARS);
                ...
                if (w2 && (e3.wysiwyg.popover.innerHTML = "", le(t3, w2, e3), se(t3, w2, e3), de(w2, e3), oe(e3, w2)), o2 && (e3.wysiwyg.popover.innerHTML = "", le(t3, o2, e3), se(t3, o2, e3), de(o2, e3), oe(e3, o2)), h2) {
                  ...
                  _2.setAttribute("type", "button"), _2.setAttribute("aria-label", window.VditorI18n.insertRowAbove + "<" + (0, d.ns)("\u21E7\u2318F") + ">"), _2.setAttribute("data-type", "insertRow"), _2.innerHTML = '<svg><use xlink:href="#vditor-icon-insert-rowb"></use></svg>', _2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n", _2.onclick = function() {
                    var n3 = getSelection().getRangeAt(0).startContainer, r3 = (0, y.lG)(n3, "TD") || (0, y.lG)(n3, "TH");
                    r3 && pt(e3, t3, r3);
                  };
                  ...
                  Z2.appendChild(R2), R2.type = "number", R2.min = "1", R2.className = "vditor-input", R2.style.width = "42px", R2.style.textAlign = "center", R2.setAttribute("placeholder", window.VditorI18n.row), R2.value = h2.rows.length.toString(), R2.oninput = function() {
                    ...
                    if (!t4.isComposing)
                      return "Tab" === t4.key ? (B2.focus(), B2.select(), void t4.preventDefault()) : void re(e3, t4);
                  };
                  ...
                  P2.appendChild(B2), B2.type = "number", B2.min = "1", B2.className = "vditor-input", B2.style.width = "42px", B2.style.textAlign = "center", B2.setAttribute("placeholder", window.VditorI18n.column), B2.value = h2.rows[0].cells.length.toString(), B2.oninput = function() {
                    ...
                    if (!t4.isComposing)
                      return "Tab" === t4.key ? (R2.focus(), R2.select(), void t4.preventDefault()) : void re(e3, t4);
                  }, le(t3, h2, e3), se(t3, h2, e3), de(h2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", T2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", M2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", A2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", _2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", x2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", O2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", D2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", I2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", j2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), e3.wysiwyg.popover.insertAdjacentHTML("beforeend", " x "), e3.wysiwyg.popover.insertAdjacentElement("beforeend", P2), oe(e3, h2);
                }
                ...
                if (V2) {
                  ...
                  Z2.appendChild(U2), U2.className = "vditor-input", U2.setAttribute("placeholder", window.VditorI18n.footnoteRef + "<" + (0, d.ns)("\u2325Enter") + ">"), U2.style.width = "120px", U2.value = V2.getAttribute("data-footnotes-label"), U2.oninput = function() {
                    ...
                    if (!n3.isComposing)
                      return (0, d.yl)(n3) || n3.shiftKey || !n3.altKey || "Enter" !== n3.key ? void re(e3, n3) : (t3.selectNodeContents(V2), t3.collapse(false), (0, N.Hc)(t3), void n3.preventDefault());
                  }, de(V2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), oe(e3, V2);
                }
                ...
                if (e3.wysiwyg.element.querySelectorAll(".vditor-wysiwyg__preview").forEach(function(e4) {
                  ...
                  if (e3.wysiwyg.popover.innerHTML = "", le(t3, W2, e3), se(t3, W2, e3), de(W2, e3), "code-block" === W2.getAttribute("data-type")) {
                    ...
                    K2.className = "vditor-input", K2.setAttribute("placeholder", window.VditorI18n.language + "<" + (0, d.ns)("\u2325Enter") + ">"), K2.value = F2.className.indexOf("language-") > -1 ? F2.className.split("-")[1].split(" ")[0] : "", K2.oninput = function(n3) {
                      ...
                      if (!n3.isComposing && !re(e3, n3)) {
                        ...
                        e3.hint.select(n3, e3), (0, d.yl)(n3) || n3.shiftKey || "Enter" !== n3.key || (t3.setStart(F2.firstChild, 0), t3.collapse(true), (0, N.Hc)(t3), n3.preventDefault(), n3.stopPropagation());
                      }
                ...
                if (v2) {
                  ...
                  Z2.appendChild(J2), J2.className = "vditor-input", J2.setAttribute("placeholder", "ID<" + (0, d.ns)("\u2325Enter") + ">"), J2.style.width = "120px", J2.value = v2.getAttribute("data-id") || "", J2.oninput = function() {
                    ...
                    if (!n3.isComposing)
                      return (0, d.yl)(n3) || n3.shiftKey || !n3.altKey || "Enter" !== n3.key ? void re(e3, n3) : (t3.selectNodeContents(v2), t3.collapse(false), (0, N.Hc)(t3), void n3.preventDefault());
                  }, le(t3, v2, e3), se(t3, v2, e3), de(v2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), oe(e3, v2);
                }
                if (f2 && ue(e3, f2), !(w2 || o2 || h2 || W2 || f2 || q2 || V2 || v2 || g2)) {
                  var Y2 = (0, y.a1)(n2, "data-block", "0");
                  Y2 && Y2.parentElement.isEqualNode(e3.wysiwyg.element) ? (e3.wysiwyg.popover.innerHTML = "", le(t3, Y2, e3), se(t3, Y2, e3), de(Y2, e3), oe(e3, Y2)) : e3.wysiwyg.popover.style.display = "none";
                }
            ...
            e3.wysiwyg.popover.innerHTML = "";
            var n2 = function() {
              "" !== i2.value.trim() && ("IMG" === t3.tagName ? t3.setAttribute("alt", i2.value) : t3.textContent = i2.value), "" !== a2.value.trim() && t3.setAttribute("data-link-label", a2.value);
            ...
            n2.setAttribute("type", "button"), n2.setAttribute("data-type", "remove"), n2.setAttribute("aria-label", window.VditorI18n.remove + "<" + (0, d.ns)("\u21E7\u2318X") + ">"), n2.innerHTML = '<svg><use xlink:href="#vditor-icon-trashcan"></use></svg>', n2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n", n2.onclick = function() {
              var n3 = (0, N.zh)(t3);
              n3.setStartAfter(e3), (0, N.Hc)(n3), e3.remove(), X(t3), ie(t3), ["H1", "H2", "H3", "H4", "H5", "H6"].includes(e3.tagName) && D(t3);
            ...
            "wysiwyg" === e3.currentMode ? ie(e3) : "ir" === e3.currentMode && J(e3);
                ...
                if (!(e4.wysiwyg.composingLock && n4 instanceof CustomEvent)) {
                  ...
                  if (t4.classList.contains("vditor-menu--current"))
                    if ("strike" === l3 && (l3 = "strikeThrough"), "quote" === l3) {
                      ...
                      "link" === l3 ? a3.collapsed ? (a3.selectNode(a3.startContainer.parentElement), document.execCommand("unlink", false, "")) : document.execCommand("unlink", false, "") : "check" === l3 || "list" === l3 || "ordered-list" === l3 ? (tt(e4, a3, l3), (0, N.ib)(e4.wysiwyg.element, a3), r3 = false, t4.classList.remove("vditor-menu--current")) : (r3 = false, t4.classList.remove("vditor-menu--current"), "" === a3.toString() ? fe(a3, e4, l3) : document.execCommand(l3, false, ""));
                  else {
                    0 === e4.wysiwyg.element.childNodes.length && (e4.wysiwyg.element.innerHTML = '<p data-block="0"><wbr></p>', (0, N.ib)(e4.wysiwyg.element, a3));
                    ...
                    if ("quote" === l3) {
                      ...
                      var k2 = "strong";
                      "italic" === l3 ? k2 = "em" : "strikeThrough" === l3 && (k2 = "s"), (m2 = document.createElement(k2)).textContent = i.g.ZWSP, a3.insertNode(m2), m2.previousSibling && m2.previousSibling.textContent === i.g.ZWSP && (m2.previousSibling.textContent = ""), a3.setStart(m2.firstChild, 1), a3.collapse(true), (0, N.Hc)(a3);
                    }
                  }
                  r3 && ie(e4), o3 && X(e4);
                }
              }(e3, r2.element.children[0], n3) : "ir" === e3.currentMode ? At(e3, r2.element.children[0], t3.prefix || "", t3.suffix || "") : Ie(e3, r2.element.children[0], t3.prefix || "", t3.suffix || ""));
            });
          }, ve = (K = function(e3, t3) {
            ...
            if ("string" != typeof n2 ? (v(e3, ["subToolbar", "hint"]), n2.preventDefault(), r2 = a(e3)) : r2 = n2, e3.currentMode !== t3 || "string" == typeof n2) {
              if (e3.devtools && e3.devtools.renderEchart(e3), "both" === e3.options.preview.mode && "sv" === t3 ? e3.preview.element.style.display = "block" : e3.preview.element.style.display = "none", p(e3.toolbar.elements, i.g.EDIT_TOOLBARS), c(e3.toolbar.elements, i.g.EDIT_TOOLBARS), m(e3.toolbar.elements, ["outdent", "indent"]), "ir" === t3)
                ...
                var o2 = He(r2, e3);
                "<div data-block='0'></div>" === o2 && (o2 = ""), e3.sv.element.innerHTML = o2, De(e3, { enableAddUndoStack: true, enableHint: false, enableInput: false }), W(e3);
              }
              e3.undo.resetIcon(e3), "string" != typeof n2 && (e3[e3.currentMode].element.focus(), pe(e3)), D(e3), z(e3), e3.toolbar.elements["edit-mode"] && (e3.toolbar.elements["edit-mode"].querySelectorAll("button").forEach(function(e4) {
                e4.classList.remove("vditor-menu--current");
              }), e3.toolbar.elements["edit-mode"].querySelector('button[data-mode="' + e3.currentMode + '"]').classList.add("vditor-menu--current")), e3.outline.toggle(e3, "sv" !== e3.currentMode && e3.options.outline.enable);
            }
          }, ye = function(e3) {
            function t3(t4, n2) {
            ...
            t3.addEventListener("dblclick", function(t4) {
              "IMG" === t4.target.tagName && (0, B.E)(t4.target, e3.options.lang, e3.options.theme);
            });
          }, ke = function(e3, t3) {
            ...
            t3.addEventListener("keydown", function(t4) {
              if (!(e3.options.hint.extend.length > 1 || e3.toolbar.elements.emoji) || !e3.hint.select(t4, e3)) {
                if (e3.options.comment.enable && "wysiwyg" === e3.currentMode && ("Backspace" === t4.key || R("\u2318X", t4)) && e3.wysiwyg.getComments(e3), "sv" === e3.currentMode) {
                  if (function(e4, t5) {
                    var n3, r2, i2, o2, a2;
                    ...
                    if (!u2 && 0 === l2.startOffset && c2 && c2.previousElementSibling && "blockquote-marker" === c2.previousElementSibling.getAttribute("data-type") && (u2 = c2.previousElementSibling), u2 && "Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && "" === u2.nextElementSibling.textContent.trim() && (0, N.im)(u2, e4.sv.element, l2).start === u2.textContent.length)
                      return "padding" === (null === (n3 = u2.previousElementSibling) || void 0 === n3 ? void 0 : n3.getAttribute("data-type")) && u2.previousElementSibling.setAttribute("data-action", "enter-remove"), u2.remove(), De(e4), t5.preventDefault(), true;
                    ...
                    if (f2 || m2 && "task-marker" !== m2.nextElementSibling.getAttribute("data-type") && (f2 = m2), f2 || 0 !== l2.startOffset || !c2 || !c2.previousElementSibling || "li-marker" !== c2.previousElementSibling.getAttribute("data-type") && "task-marker" !== c2.previousElementSibling.getAttribute("data-type") || (f2 = c2.previousElementSibling), f2) {
                      var h2 = (0, N.im)(f2, e4.sv.element, l2).start, v2 = "task-marker" === f2.getAttribute("data-type"), g2 = f2;
                      if (v2 && (g2 = f2.previousElementSibling.previousElementSibling.previousElementSibling), h2 === f2.textContent.length) {
                        if ("Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey && "" === f2.nextElementSibling.textContent.trim())
                          return "padding" === (null === (r2 = g2.previousElementSibling) || void 0 === r2 ? void 0 : r2.getAttribute("data-type")) ? (g2.previousElementSibling.remove(), q(e4)) : (v2 && (g2.remove(), f2.previousElementSibling.previousElementSibling.remove(), f2.previousElementSibling.remove()), f2.nextElementSibling.remove(), f2.remove(), De(e4)), t5.preventDefault(), true;
                        if ("Tab" === t5.key)
                    ...
                    if ("Backspace" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey) {
                      if (E2 && "newline" === (null === (o2 = E2.previousElementSibling) || void 0 === o2 ? void 0 : o2.getAttribute("data-type")) && 1 === (0, N.im)(E2, e4.sv.element, l2).start && -1 === E2.getAttribute("data-type").indexOf("code-block-"))
                        return l2.setStart(E2, 0), l2.extractContents(), "" !== E2.textContent.trim() ? q(e4) : De(e4), t5.preventDefault(), true;
                      if (w2 && 0 === (0, N.im)(w2, e4.sv.element, l2).start && w2.previousElementSibling) {
                        l2.extractContents();
                        var L2 = w2.previousElementSibling.lastElementChild;
                        return "newline" === L2.getAttribute("data-type") && (L2.remove(), L2 = w2.previousElementSibling.lastElementChild), "newline" !== L2.getAttribute("data-type") && (L2.insertAdjacentHTML("afterend", w2.innerHTML), w2.remove()), "" === w2.textContent.trim() || (null === (a2 = w2.previousElementSibling) || void 0 === a2 ? void 0 : a2.querySelector('[data-type="code-block-open-marker"]')) ? ("newline" !== L2.getAttribute("data-type") && (l2.selectNodeContents(L2.lastChild), l2.collapse(false)), De(e4)) : q(e4), t5.preventDefault(), true;
                      }
                    }
                    return false;
                  }(e3, t4))
                  ...
                  if (function(e4, t5) {
                    ...
                    if (!Ke(t5, e4, r2))
                      return false;
                    if (Fe(n3, e4, t5), Et(n3), "Enter" !== t5.key && "Tab" !== t5.key && "Backspace" !== t5.key && -1 === t5.key.indexOf("Arrow") && !(0, d.yl)(t5) && "Escape" !== t5.key && "Delete" !== t5.key)
                      return false;
                    ...
                    if (l2) {
                      ...
                      if ("0" === l2.getAttribute("data-block")) {
                        ...
                        if ($e(e4, t5, n3, l2.firstElementChild, l2))
                          return true;
                        if ("yaml-front-matter" !== l2.getAttribute("data-type") && et(e4, t5, n3, l2.firstElementChild, l2))
                          return true;
                      }
                    }
                    if (yt(e4, n3, t5, a2))
                    ...
                    if (m2) {
                      ...
                      "Backspace" !== t5.key || (0, d.yl)(t5) || t5.shiftKey || t5.altKey || 1 !== m2.textContent.length || te(e4);
                    }
                    if (bt(e4, n3, t5))
                      return true;
                    ...
                    if (Ze(n3, t5.key), "ArrowDown" === t5.key) {
                      var C2 = r2.nextSibling;
                      C2 && 3 !== C2.nodeType && "math-inline" === C2.getAttribute("data-type") && n3.setStartAfter(C2);
                    }
                  ...
                  if (c2 && "PRE" === c2.tagName) {
                    ...
                    if (gt(e4, t5, c2, n3))
                      return true;
                    if (("math-block" === u2.getAttribute("data-type") || "html-block" === u2.getAttribute("data-type")) && et(e4, t5, n3, u2, c2.parentElement))
                      return true;
                ...
                if ((0, d.yl)(t4) && t4.altKey && !t4.shiftKey && /^Digit[1-6]$/.test(t4.code)) {
                  if ("wysiwyg" === e3.currentMode) {
                    ...
                    "sv" === e3.currentMode ? Oe(e3, "#".repeat(parseInt(t4.code.replace("Digit", ""), 10)) + " ") : "ir" === e3.currentMode && Tt(e3, "#".repeat(parseInt(t4.code.replace("Digit", ""), 10)) + " ");
                  return t4.preventDefault(), true;
                }
                if ((0, d.yl)(t4) && t4.altKey && !t4.shiftKey && /^Digit[7-9]$/.test(t4.code))
                  return "Digit7" === t4.code ? ge(e3, "wysiwyg", t4) : "Digit8" === t4.code ? ge(e3, "ir", t4) : "Digit9" === t4.code && ge(e3, "sv", t4), true;
              ...
              if ("li-marker" === o2 || "blockquote-marker" === o2 || "task-marker" === o2 || "padding" === o2) {
                ...
                if ("li-marker" !== o2 || "code-block-open-marker" !== t3 && "code-block-info" !== t3)
                  if ("code-block-close-marker" === t3 && n2.nextElementSibling.isSameNode(e3)) {
                    var l2 = _e(e3, "code-block-open-marker");
            ...
            if (!("Enter" === n2.key || "Tab" === n2.key || "Backspace" === n2.key || n2.key.indexOf("Arrow") > -1 || (0, d.yl)(n2) || "Escape" === n2.key || n2.shiftKey || n2.altKey)) {
              ...
              if (r2 && 0 === (0, N.im)(r2, t3[t3.currentMode].element, e3).start) {
            ...
            if ("ArrowDown" === t3.key && -1 === r2.textContent.trimRight().substr(a2.start).indexOf("\n") || "ArrowRight" === t3.key && a2.start >= r2.textContent.trimRight().length) {
              ...
              return !l2 || l2 && ("TABLE" === l2.tagName || l2.getAttribute("data-type")) ? (o2.insertAdjacentHTML("afterend", '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"), (0, N.ib)(e3[e3.currentMode].element, n2)) : (n2.selectNodeContents(l2), n2.collapse(true), (0, N.Hc)(n2)), t3.preventDefault(), true;
            }
            return false;
            ...
            if ("ArrowUp" === t3.key && -1 === r2.textContent.substr(0, a2.start).indexOf("\n") || ("ArrowLeft" === t3.key || "Backspace" === t3.key && "" === n2.toString()) && 0 === a2.start) {
              ...
              return !l2 || l2 && ("TABLE" === l2.tagName || l2.getAttribute("data-type")) ? (o2.insertAdjacentHTML("beforebegin", '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"), (0, N.ib)(e3[e3.currentMode].element, n2)) : (n2.selectNodeContents(l2), n2.collapse(false), (0, N.Hc)(n2)), t3.preventDefault(), true;
            }
            return false;
            ...
            if (t3 && r2) {
              ...
              }), r2.insertAdjacentHTML("beforeend", "<" + o2.tagName + ' data-block="0">' + a2 + "</" + o2.tagName + ">"), "wysiwyg" === e3.currentMode ? o2.outerHTML = e3.lute.SpinVditorDOM(o2.outerHTML) : o2.outerHTML = e3.lute.SpinVditorIRDOM(o2.outerHTML), (0, N.ib)(e3[e3.currentMode].element, n2);
              var l2 = (0, y.O9)(n2.startContainer);
              l2 && l2.querySelectorAll(".vditor-" + e3.currentMode + "__preview[data-render='2']").forEach(function(t4) {
                H(t4, e3), "wysiwyg" === e3.currentMode && t4.previousElementSibling.setAttribute("style", "display:none");
              }), lt(e3), pe(e3);
            } else
            ...
            if (i2) {
              ...
              }), d2 && (a2.innerHTML = d2, l2[0].insertAdjacentElement("beforeend", a2)), "wysiwyg" === e3.currentMode ? r2.outerHTML = e3.lute.SpinVditorDOM(r2.outerHTML) : r2.outerHTML = e3.lute.SpinVditorIRDOM(r2.outerHTML), (0, N.ib)(e3[e3.currentMode].element, n2);
            ...
            void 0 === t3 && (t3 = { enableAddUndoStack: true, enableHint: false, enableInput: true }), "wysiwyg" === e3.currentMode ? X(e3, t3) : "ir" === e3.currentMode ? Lt(e3, t3) : "sv" === e3.currentMode && De(e3, t3);
            ...
            if (l2) {
              ...
              if (!((0, d.yl)(r2) || r2.shiftKey || r2.altKey || "Backspace" !== r2.key || l2.previousElementSibling || "" !== e3.toString() || 0 !== (0, N.im)(l2, t3[t3.currentMode].element, e3).start))
            ...
            "TH" === n2.tagName ? n2.parentElement.parentElement.insertAdjacentHTML("afterend", "<tbody><tr>" + r2 + "</tr></tbody>") : n2.parentElement.insertAdjacentHTML("afterend", "<tr>" + r2 + "</tr>"), lt(e3);
            ...
            if ("TD" === n2.tagName) {
              ...
              n2.parentElement.previousElementSibling ? t3.selectNodeContents(n2.parentElement.previousElementSibling.lastElementChild) : t3.selectNodeContents(r2.previousElementSibling.lastElementChild.lastElementChild), 1 === r2.childElementCount ? r2.remove() : n2.parentElement.remove(), t3.collapse(false), (0, N.Hc)(t3), lt(e3);
            }
            ...
            if (a2 && "" === t3.toString()) {
              ...
              var s2 = (0, y.F9)(o2);
              if ("wysiwyg" === e3.currentMode && s2 && R("\u21E7\u2318;", n2))
            ...
            if (r2) {
              ...
              if (o2 && 0 === (0, N.im)(r2, e3[e3.currentMode].element, t3).start && ((0, d.vU)() && "HR" === o2.tagName || "TABLE" === o2.tagName)) {
                if ("TABLE" === o2.tagName) {
                ...
                switch (E2.label) {
                  ...
                  case 2:
                    return "" === r2.trim() ? [3, 3] : ((f2 = document.createElement("div")).innerHTML = r2, f2.querySelectorAll("[style]").forEach(function(e4) {
                      ...
                      e4.remove();
                    }), "ir" === e3.currentMode ? (l2.HTML2VditorIRDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), (0, N.oC)(e3.lute.HTML2VditorIRDOM(f2.innerHTML), e3)) : "wysiwyg" === e3.currentMode ? (l2.HTML2VditorDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), (0, N.oC)(e3.lute.HTML2VditorDOM(f2.innerHTML), e3)) : (l2.Md2VditorSVDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), xe(e3, e3.lute.HTML2Md(f2.innerHTML).trimRight())), e3.outline.render(e3), [3, 8]);
                  case 3:
                    return a2.length > 0 ? e3.options.upload.url || e3.options.upload.handler ? [4, Ve(e3, a2)] : [3, 5] : [3, 7];
                  case 4:
                    return E2.sent(), [3, 6];
                  case 5:
                  ...
                  case 6:
                    return [3, 8];
                  case 7:
                    "" !== o2.trim() && 0 === a2.length && ("ir" === e3.currentMode ? (l2.Md2VditorIRDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), (0, N.oC)(e3.lute.Md2VditorIRDOM(o2), e3)) : "wysiwyg" === e3.currentMode ? (l2.Md2VditorDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), (0, N.oC)(e3.lute.Md2VditorDOM(o2), e3)) : (l2.Md2VditorSVDOM = { renderLinkDest: s2 }, e3.lute.SetJSRenderers({ renderers: l2 }), xe(e3, o2)), e3.outline.render(e3)), E2.label = 8;
                  case 8:
                    return "sv" !== e3.currentMode && ((g2 = (0, y.F9)((0, N.zh)(e3).startContainer)) && (b2 = (0, N.zh)(e3), e3[e3.currentMode].element.querySelectorAll("wbr").forEach(function(e4) {
                      e4.remove();
                    }), b2.insertNode(document.createElement("wbr")), "wysiwyg" === e3.currentMode ? g2.outerHTML = e3.lute.SpinVditorDOM(g2.outerHTML) : g2.outerHTML = e3.lute.SpinVditorIRDOM(g2.outerHTML), (0, N.ib)(e3[e3.currentMode].element, b2)), e3[e3.currentMode].element.querySelectorAll(".vditor-" + e3.currentMode + "__preview[data-render='2']").forEach(function(t4) {
                      H(t4, e3);
            ...
            if (t3.classList.contains("vditor-menu--current"))
              if ("quote" === o2) {
                ...
                "italic" === o2 ? Mt(i2, e3, "em") : "bold" === o2 ? Mt(i2, e3, "strong") : "strike" === o2 ? Mt(i2, e3, "s") : "inline-code" === o2 ? Mt(i2, e3, "code") : "check" !== o2 && "list" !== o2 && "ordered-list" !== o2 || (tt(e3, i2, o2), l2 = false, t3.classList.remove("vditor-menu--current"));
            else {
              0 === e3.ir.element.childNodes.length && (e3.ir.element.innerHTML = '<p data-block="0"><wbr></p>', (0, N.ib)(e3.ir.element, i2));
              ...
              if ("line" === o2) {
                ...
                f2 = void 0;
                "" === i2.toString() ? f2 = n2 + "<wbr>" + r2 : (f2 = "code" === o2 || "table" === o2 ? "" + n2 + i2.toString() + "<wbr>" + r2 : "" + n2 + i2.toString() + r2 + "<wbr>", i2.deleteContents()), "table" !== o2 && "code" !== o2 || (f2 = "\n" + f2 + "\n\n");
                var h2 = document.createElement("span");
                h2.innerHTML = f2, i2.insertNode(h2), j(e3, i2), "table" === o2 && (i2.selectNodeContents(getSelection().getRangeAt(0).startContainer.parentElement), (0, N.Hc)(i2));
              } else
                "check" !== o2 && "list" !== o2 && "ordered-list" !== o2 || (tt(e3, i2, o2, false), l2 = false, c(e3.toolbar.elements, ["check", "list", "ordered-list"]), t3.classList.add("vditor-menu--current"));
            }
            ...
            function e3(e4) {
              ...
              this.splitChar = "", this.lastIndex = -1, this.fillEmoji = function(e5, n2) {
                ...
                if (o2.setStart(o2.startContainer, t3.lastIndex), o2.deleteContents(), n2.options.hint.parse ? "sv" === n2.currentMode ? (0, N.oC)(n2.lute.SpinVditorSVDOM(r2), n2) : "wysiwyg" === n2.currentMode ? (0, N.oC)(n2.lute.SpinVditorDOM(r2), n2) : (0, N.oC)(n2.lute.SpinVditorIRDOM(r2), n2) : (0, N.oC)(r2, n2), ":" === t3.splitChar && r2.indexOf(":") > -1 && "sv" !== n2.currentMode && o2.insertNode(document.createTextNode(" ")), o2.collapse(false), (0, N.Hc)(o2), "wysiwyg" === n2.currentMode)
            ...
            return e3.prototype.render = function(e4) {
              ...
              var r2 = this;
              if (0 !== e4.length) {
                var i2 = n2[n2.currentMode].element, o2 = (0, N.Ny)(i2), a2 = o2.left + ("left" === n2.options.outline.position ? n2.outline.element.offsetWidth : 0), l2 = o2.top, s2 = "";
            ...
            return e3.prototype.copy = function(e4, t3) {
              ...
              this.element.addEventListener("paste", function(t4) {
                ...
                if ("deleteByDrag" !== n2.inputType && "insertFromDrop" !== n2.inputType)
                  return t3.preventInput ? (t3.preventInput = false, void Lt(e4, { enableAddUndoStack: true, enableHint: true, enableInput: true })) : void (t3.composingLock || "\u2018" === n2.data || "\u201C" === n2.data || "\u300A" === n2.data || j(e4, getSelection().getRangeAt(0).cloneRange(), false, n2));
                ...
                if (o2 || (o2 = (0, y.fb)(r2.startContainer, "vditor-ir__preview")), o2 && (o2.previousElementSibling.firstElementChild ? r2.selectNodeContents(o2.previousElementSibling.firstElementChild) : r2.selectNodeContents(o2.previousElementSibling), r2.collapse(true), (0, N.Hc)(r2), Te(e4)), "IMG" === n2.target.tagName) {
                ...
                if (!l2 || l2.classList.contains("vditor-ir__node--expand")) {
                  if (n2.target.isEqualNode(t3.element) && t3.element.lastElementChild && r2.collapsed) {
                    ...
                    n2.y > s2.top + s2.height && ("P" === t3.element.lastElementChild.tagName && "" === t3.element.lastElementChild.textContent.trim().replace(i.g.ZWSP, "") ? (r2.selectNodeContents(t3.element.lastElementChild), r2.collapse(false)) : (t3.element.insertAdjacentHTML("beforeend", '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"), (0, N.ib)(t3.element, r2)));
                  }
                ...
                if (!n2.isComposing && !(0, d.yl)(n2))
                  if ("Enter" === n2.key && Te(e4), J(e4), "Backspace" !== n2.key && "Delete" !== n2.key || "" === e4.ir.element.innerHTML || 1 !== e4.ir.element.childNodes.length || !e4.ir.element.firstElementChild || "P" !== e4.ir.element.firstElementChild.tagName || 0 !== e4.ir.element.firstElementChild.childElementCount || "" !== e4.ir.element.textContent && "\n" !== e4.ir.element.textContent) {
                    var r2 = (0, N.zh)(e4);
                    "Backspace" === n2.key ? ((0, d.vU)() && "\n" === r2.startContainer.textContent && 1 === r2.startOffset && (r2.startContainer.textContent = "", P(r2, e4)), t3.element.querySelectorAll(".language-math").forEach(function(e5) {
                      var t4 = e5.querySelector("br");
                      t4 && t4.remove();
                    })) : n2.key.indexOf("Arrow") > -1 ? ("ArrowLeft" !== n2.key && "ArrowRight" !== n2.key || Ct(e4), P(r2, e4)) : 229 === n2.keyCode && "" === n2.code && "Unidentified" === n2.key && P(r2, e4);
            ...
            return e3.prototype.render = function(e4) {
              return "block" === e4.preview.element.style.display ? (0, It.k)(e4.preview.element.lastElementChild, this.element.lastElementChild, e4) : (0, It.k)(e4[e4.currentMode].element, this.element.lastElementChild, e4);
            }, e3.prototype.toggle = function(e4, t3) {
              var n2;
              void 0 === t3 && (t3 = true);
              var r2 = null === (n2 = e4.toolbar.elements.outline) || void 0 === n2 ? void 0 : n2.firstElementChild;
              if (t3 && window.innerWidth >= i.g.MOBILE_WIDTH ? (this.element.style.display = "block", this.render(e4), null == r2 || r2.classList.add("vditor-menu--current")) : (this.element.style.display = "none", null == r2 || r2.classList.remove("vditor-menu--current")), getSelection().rangeCount > 0) {
            ...
            function e3(e4) {
              ...
              n2.className = "vditor-reset", e4.options.classes.preview && n2.classList.add(e4.options.classes.preview), n2.style.maxWidth = e4.options.preview.maxWidth + "px", n2.addEventListener("copy", function(n3) {
                ...
                if (i3 && (0, y.fb)(i3, "vditor-toc")) {
                  ...
                  "IMG" === r3.target.tagName && (0, B.E)(r3.target, e4.options.lang, e4.options.theme);
              });
            ...
            return e3.prototype.render = function(e4, t3) {
              ...
              r2 && r2.classList.remove("vditor-comment--focus"), (0, S.O)(e4.preview.element.lastElementChild), (0, T.s)(e4.options.preview.hljs, e4.preview.element.lastElementChild, e4.options.cdn), (0, A.i)(e4.preview.element.lastElementChild, e4.options.cdn, e4.options.theme), (0, C.P)(e4.preview.element.lastElementChild, e4.options.cdn), (0, L.v)(e4.preview.element.lastElementChild, e4.options.cdn), (0, k.p)(e4.preview.element.lastElementChild, e4.options.cdn, e4.options.theme), (0, x.P)(e4.preview.element.lastElementChild, e4.options.cdn, e4.options.theme), (0, _.B)(e4.preview.element.lastElementChild, e4.options.cdn), (0, E.Q)(e4.preview.element.lastElementChild, e4.options.cdn), (0, Rt.Y)(e4.preview.element.lastElementChild);
              ...
              r2.selectNode(t3), (0, N.Hc)(r2), document.execCommand("copy"), this.element.lastElementChild.remove(), e4.tip.show("\u5DF2\u590D\u5236\uFF0C\u53EF\u5230" + ("zhihu" === n2 ? "\u77E5\u4E4E" : "\u5FAE\u4FE1\u516C\u4F17\u53F7\u5E73\u53F0") + "\u8FDB\u884C\u7C98\u8D34");
            }, e3;
          }(), Bt = function() {
            function e3(e4) {
            ...
            function t3(t4, n2) {
              ...
              return "both" === t4.options.preview.mode && r2.element.children[0].classList.add("vditor-menu--current"), r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
                r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || (e4.preventDefault(), "sv" === t4.currentMode && ("both" === t4.options.preview.mode ? Ut("editor", t4) : Ut("both", t4)));
              }), r2;
            }
            return Wt(t3, e3), t3;
          }(he), Gt = function() {
            ...
            function t3(t4, n2) {
              ...
              return i.g.CODE_THEME.forEach(function(e4) {
                ...
                "BUTTON" === e4.target.tagName && (v(t4, ["subToolbar"]), t4.options.preview.hljs.style = e4.target.textContent, (0, Kt.Y)(e4.target.textContent, t4.options.cdn), e4.preventDefault(), e4.stopPropagation());
            ...
            function t3(t4, n2) {
              ...
              return Object.keys(t4.options.preview.theme.list).forEach(function(e4) {
                ...
                "BUTTON" === e4.target.tagName && (v(t4, ["subToolbar"]), t4.options.preview.theme.current = e4.target.getAttribute("data-type"), (0, V.Z)(t4.options.preview.theme.current, t4.options.preview.theme.path), e4.preventDefault(), e4.stopPropagation());
            ...
            return rn(t3, e3), t3.prototype.bindEvent = function(e4) {
              var t4 = this;
              this.element.lastElementChild.addEventListener((0, d.Le)(), function(n2) {
                var r2 = (0, b.S)(n2.target, "BUTTON");
                if (r2) {
                  n2.preventDefault();
                  var i2 = r2.getAttribute("data-value"), o2 = (0, N.zh)(e4), a2 = i2;
                  ...
                  o2.collapse(false), (0, N.Hc)(o2), t4.element.lastElementChild.style.display = "none", lt(e4);
                }
...
<script src="` + e5.options.cdn + "/dist/js/icons/" + e5.options.icon + '.js"><\/script></body></html>';
            ...
            return un(t3, e3), t3.prototype._bindEvent = function(e4, t4) {
              ...
              n2.addEventListener((0, d.Le)(), function(r3) {
                r3.preventDefault(), n2.classList.contains(i.g.CLASS_MENU_DISABLED) || (n2.blur(), n2.classList.contains("vditor-menu--current") ? ("wysiwyg" === e4.currentMode ? (te(e4), X(e4)) : "ir" === e4.currentMode && Tt(e4, ""), n2.classList.remove("vditor-menu--current")) : (v(e4, ["subToolbar"]), t4.style.display = "block"));
              });
              for (var r2 = 0; r2 < 6; r2++)
                t4.children.item(r2).addEventListener((0, d.Le)(), function(r3) {
                  r3.preventDefault(), "wysiwyg" === e4.currentMode ? (ee(e4, r3.target.getAttribute("data-tag")), X(e4), n2.classList.add("vditor-menu--current")) : "ir" === e4.currentMode ? (Tt(e4, r3.target.getAttribute("data-value")), n2.classList.add("vditor-menu--current")) : Oe(e4, r3.target.getAttribute("data-value")), t4.style.display = "none";
                });
            }, t3;
          }(he), mn = function() {
            var e3 = function(t3, n2) {
            ...
            function t3(t4, n2) {
              var r2 = e3.call(this, t4, n2) || this;
              return r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
                e4.preventDefault(), r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t4.currentMode || Je(t4, "afterend");
              }), r2;
            }
            return bn(t3, e3), t3;
          }(he), En = function() {
            ...
            function t3(t4, n2) {
              var r2 = e3.call(this, t4, n2) || this;
              return r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
                e4.preventDefault(), r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t4.currentMode || Je(t4, "beforebegin");
              }), r2;
            }
            return En(t3, e3), t3;
          }(he), Sn = function() {
                ...
                if (r2.preventDefault(), !n2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED)) {
                  ...
                  if (t4)
                    ...
                    navigator.mediaDevices.getUserMedia({ audio: true }).then(function(r3) {
                      (t4 = new xn(r3)).recorder.onaudioprocess = function(e5) {
                        if (t4.isRecording) {
            ...
            return jn(t3, e3), t3.prototype._bindEvent = function(e4) {
              ...
              this.element.children[0].addEventListener((0, d.Le)(), function(e5) {
                ...
                0 !== n2.target.files.length && Ve(e4, n2.target.files, n2.target);
              });
            }, t3;
          }(he), Pn = function() {
            function e3(e4) {
            ...
            return e3.prototype.clearStack = function(e4) {
              ...
              D(t3), lt(t3, { enableAddUndoStack: false, enableHint: false, enableInput: true }), pe(t3), t3[t3.currentMode].element.querySelectorAll(".vditor-" + t3.currentMode + "__preview[data-render='2']").forEach(function(e5) {
                H(e5, t3);
            ...
            return e3.prototype.getComments = function(e4, t3) {
              ...
              this.unbindListener(), window.addEventListener("scroll", this.scrollListener = function() {
                ...
                if ("deleteByDrag" !== n2.inputType && "insertFromDrop" !== n2.inputType) {
                  if (t3.preventInput)
                    return t3.preventInput = false, void X(e4);
                  if (t3.composingLock || "\u2018" === n2.data || "\u201C" === n2.data || "\u300A" === n2.data)
                    ...
                    if (i2 || ($(e4, r2), i2 = (0, y.F9)(r2.startContainer)), i2) {
                      for (var o2 = (0, N.im)(i2, e4.wysiwyg.element, r2).start, l2 = true, s2 = o2 - 1; s2 > i2.textContent.substr(0, o2).lastIndexOf("\n"); s2--)
                      ...
                      c2 && "" === c2.textContent && (D(e4), c2.remove()), l2 && "code-block" !== i2.getAttribute("data-type") || d2 || at(i2.innerHTML) || ot(i2.innerHTML) && i2.previousElementSibling ? "function" == typeof e4.options.input && e4.options.input(a(e4)) : Ue(e4, r2, n2);
                    }
                  }
                }
              }), this.element.addEventListener("click", function(n2) {
                ...
                if ("IMG" !== n2.target.tagName || n2.target.parentElement.classList.contains("vditor-wysiwyg__preview")) {
                  "A" === n2.target.tagName && window.open(n2.target.getAttribute("href"));
                  var o2 = (0, N.zh)(e4);
                  if (n2.target.isEqualNode(t3.element) && t3.element.lastElementChild && o2.collapsed) {
                    ...
                    n2.y > a2.top + a2.height && ("P" === t3.element.lastElementChild.tagName && "" === t3.element.lastElementChild.textContent.trim().replace(i.g.ZWSP, "") ? (o2.selectNodeContents(t3.element.lastElementChild), o2.collapse(false)) : (t3.element.insertAdjacentHTML("beforeend", '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"), (0, N.ib)(t3.element, o2)));
                  }
                  ie(e4);
                  ...
                  "link-ref" === n2.target.getAttribute("data-type") ? ae(e4, n2.target) : function(e5, t4) {
                    var n3 = e5.target;
                ...
                if (!t4.isComposing && !(0, d.yl)(t4)) {
                  "Enter" === t4.key && Te(e4), "Backspace" !== t4.key && "Delete" !== t4.key || "" === e4.wysiwyg.element.innerHTML || 1 !== e4.wysiwyg.element.childNodes.length || !e4.wysiwyg.element.firstElementChild || "P" !== e4.wysiwyg.element.firstElementChild.tagName || 0 !== e4.wysiwyg.element.firstElementChild.childElementCount || "" !== e4.wysiwyg.element.textContent && "\n" !== e4.wysiwyg.element.textContent || (e4.wysiwyg.element.innerHTML = "");
                  var n2 = (0, N.zh)(e4);
                  if ("Backspace" === t4.key && (0, d.vU)() && "\n" === n2.startContainer.textContent && 1 === n2.startOffset && (n2.startContainer.textContent = ""), $(e4, n2), ie(e4), "ArrowDown" === t4.key || "ArrowRight" === t4.key || "Backspace" === t4.key || "ArrowLeft" === t4.key || "ArrowUp" === t4.key) {
                    ...
                    if (r2)
                      if ("none" !== r2.previousElementSibling.style.display) {
                        ...
                        "ArrowDown" === t4.key || "ArrowRight" === t4.key ? ne(r2, e4) : ne(r2, e4, false);
                  }
                }
              });
            }, e3;
          ...
          const Gn = function(e3) {
            ...
            return zn(t3, e3), t3.prototype.setTheme = function(e4, t4, n2, r2) {
              ...
              e4 && e4.remove(), this.clearCache(), G(), this.vditor.wysiwyg.unbindListener();
              ...
              if ("wysiwyg" === this.vditor.currentMode) {
                var n2 = function(e5, n3) {
                  ...
                  }), 0 === r2.length ? (e5.outerHTML = e5.innerHTML, (0, N.zh)(t4.vditor).collapse(true)) : e5.setAttribute("data-cmtids", r2.join(" "));
                };
                e4.forEach(function(e5) {
              ...
              this.vditor = { currentMode: t4.mode, element: e4, hint: new Ht(t4.hint.extend), lute: void 0, options: t4, originalInnerHTML: e4.innerHTML, outline: new jt(window.VditorI18n.outline), tip: new Vt() }, this.vditor.sv = new qt(this.vditor), this.vditor.undo = new qn(), this.vditor.wysiwyg = new Wn(this.vditor), this.vditor.ir = new Nt(this.vditor), this.vditor.toolbar = new Pn(this.vditor), t4.resize.enable && (this.vditor.resize = new Bt(this.vditor)), this.vditor.toolbar.elements.devtools && (this.vditor.devtools = new s()), (t4.upload.url || t4.upload.handler) && (this.vditor.upload = new qe()), (0, l.G)(t4._lutePath || t4.cdn + "/dist/js/lute/lute.min.js", "vditorLuteScript").then(function() {
                n2.vditor.lute = (0, Ot.X)({ autoSpace: n2.vditor.options.preview.markdown.autoSpace, codeBlockPreview: n2.vditor.options.preview.markdown.codeBlockPreview, emojiSite: n2.vditor.options.hint.emojiPath, emojis: n2.vditor.options.hint.emoji, fixTermTypo: n2.vditor.options.preview.markdown.fixTermTypo, footnotes: n2.vditor.options.preview.markdown.footnotes, headingAnchor: false, inlineMathDigit: n2.vditor.options.preview.math.inlineDigit, linkBase: n2.vditor.options.preview.markdown.linkBase, linkPrefix: n2.vditor.options.preview.markdown.linkPrefix, listStyle: n2.vditor.options.preview.markdown.listStyle, mark: n2.vditor.options.preview.markdown.mark, mathBlockPreview: n2.vditor.options.preview.markdown.mathBlockPreview, paragraphBeginningSpace: n2.vditor.options.preview.markdown.paragraphBeginningSpace, sanitize: n2.vditor.options.preview.markdown.sanitize, toc: n2.vditor.options.preview.markdown.toc }), n2.vditor.preview = new Pt(n2.vditor), function(e5) {
                  ...
                  if (t5.className = "vditor-content", "left" === e5.options.outline.position && t5.appendChild(e5.outline.element), t5.appendChild(e5.wysiwyg.element.parentElement), t5.appendChild(e5.sv.element), t5.appendChild(e5.ir.element.parentElement), t5.appendChild(e5.preview.element), e5.toolbar.elements.devtools && t5.appendChild(e5.devtools.element), "right" === e5.options.outline.position && (e5.outline.element.classList.add("vditor-outline--right"), t5.appendChild(e5.outline.element)), e5.upload && t5.appendChild(e5.upload.element), e5.options.resize.enable && t5.appendChild(e5.resize.element), t5.appendChild(e5.hint.element), t5.appendChild(e5.tip.element), e5.element.appendChild(t5), t5.addEventListener("click", function() {
                    v(e5, ["subToolbar"]);
                  }), e5.toolbar.elements.export && e5.element.insertAdjacentHTML("beforeend", '<iframe style="width: 100%;height: 0;border: 0"></iframe>'), ge(e5, e5.options.mode, Z(e5)), document.execCommand("DefaultParagraphSeparator", false, "p"), navigator.userAgent.indexOf("iPhone") > -1 && void 0 !== window.visualViewport) {
...
// dep:vditor
var vditor_default = require_index_min();
export {
  vditor_default as default
};

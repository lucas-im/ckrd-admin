...
function createLanguageContext(host, extraPlugins = [], exts = ['.vue', '.md', '.html']) {
                ...
                if (exts.some(ext => vueFileName.endsWith(ext))) {
                    ...
                    if (!vueFile) {
                        ...
                        if (fileExists) {
                            ...
                            if (scriptSnapshot) {
                                documentRegistry.set(vueFileName, (0, sourceFile_1.createSourceFile)(vueFileName, scriptSnapshot, vueCompilerOptions, ts, plugins));
                            }
                        }
                    }
                }
    ...
    function update() {
        ...
        for (const fileName of [
            ...
            if (!sourceFile) {
                documentRegistry.set(fileName, (0, sourceFile_1.createSourceFile)(fileName, scriptSnapshot, vueCompilerOptions, ts, plugins));
                tsFileUpdated = true;
            }
            else {
                const oldScripts = {};

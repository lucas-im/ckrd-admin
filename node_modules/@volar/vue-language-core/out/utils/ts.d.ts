...
export declare function createParsedCommandLine(ts: typeof import('typescript/lib/tsserverlibrary'), parseConfigHost: ts.ParseConfigHost, tsConfig: string, extendsSet?: Set<string>): ParsedCommandLine;
export declare function getVueCompilerOptions(vueOptions: VueCompilerOptions): _VueCompilerOptions;

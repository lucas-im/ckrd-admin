...
;
function createSourceFile(fileName, scriptSnapshot, vueCompilerOptions, ts, plugins) {
    // refs
    ...
    const compiledSFCTemplate = (0, reactivity_1.computed)(() => {
        ...
        if (sfc.template) {
            ...
            for (const plugin of plugins) {
                ...
                let result;
                try {
                    result = (_a = plugin.compileSFCTemplate) === null || _a === void 0 ? void 0 : _a.call(plugin, sfc.template.lang, sfc.template.content, Object.assign({ onError: (err) => errors.push(err), onWarn: (err) => warnings.push(err), expressionPlugins: ['typescript'] }, vueCompilerOptions.experimentalTemplateCompilerOptions));
                }
                catch (e) {
                    const err = e;
                    errors.push(err);

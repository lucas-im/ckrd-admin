...
export declare function createSourceFile(fileName: string, scriptSnapshot: ts.IScriptSnapshot, vueCompilerOptions: VueCompilerOptions, ts: typeof import('typescript/lib/tsserverlibrary'), plugins: ReturnType<VueLanguagePlugin>[]): {
    fileName: string;
